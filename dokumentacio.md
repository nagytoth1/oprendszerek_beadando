...
| NET_26          | Az iskola weboldalára működik a névfeloldás                                                          | Sikeres         | A router DNS-konfigurációját teszteljük                          |
| NET_27          | Az Internal gépei ki tudnak menni az internetre, a névfeloldás interneten is működik                 | Sikeres         | A kliensek Cloudflare DNS-szerverrel való kapcsolatát teszteljük |
| NET_28          | Az Internalon kívüli alhálózatok is ki tudnak menni az internetre, a névfeloldás számukra is működik | Sikeres         | A kliensek Cloudflare DNS-szerverrel való kapcsolatát teszteljük |
| WEB_01          | Az iskola weboldalán működik a navigációs sáv                                                        | Sikeres         | Weboldalak megvalósítását teszteljük                             |
| WEB_02          | Az iskola weboldalán elérhetőek, letölthetőek az érettségi tételek                                   | Sikeres         | Weboldalak megvalósítását teszteljük                             |
...
**todo**: maradék 5 tesztet elvégezni Leventével, eredményüket beírni a táblázatba

| Teszt azonosítója | Teszt leírása                                                                                                                                                                                     | Elvárt eredmény | Teszt eredménye | Tesztelés dátuma<br>(év-hónap-nap) |
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------- | --------------- | ---------------------------------- |
| NET_01            | Winbox programba beírjuk a router ether1 interfészének címét (Mikrotikben /ip address print), és beírjuk az adminisztrátor jelszavát. A teszt sikeres akkor, ha a konfigurációs felületet látjuk. | Sikeres         | Sikeres         | 2023-12-02                         |
...
| NET_26            | Tetszőleges kliensgépen ping www.blg.lan parancsot futtattuk terminálban                                                                                                                          | Sikeres         | Sikeres         | 2023-12-05                         |
| NET_27            | Internal alhálózatra kapcsolt kliensgépen<br>ping 8.8.8.8 és ping google.hu parancsokat futtattuk terminálban                                                                                     | Sikeres         | Sikeres         | 2023-12-05                         |
| NET_28            | gepterem1 és gepterem2 és gepterem3 alhálózatra kapcsolt kliensgépen<br>ping 8.8.8.8 és ping google.hu parancsokat futtattuk terminálban                                                          | Sikeres         | Sikeres         | 2023-12-05                         |
| WEB_01            | Az iskola honlapján a navigációs sáv<br>gombjaira kattintgatunk, és figyeljük, hogy mindegyik gomb megfelelő helyre irányít-e.                                                                    | Sikeres         | Sikeres         | 2023-12-05                         |
| WEB_02            | Az "Érettségi" oldalon a kitűzött tematikák linkjeire kattintunk, és figyeljük, hogy a letöltés elkezdődik-e.                                                                                     | Sikeres         | Sikertelen      | 2023-12-05                         |

WEB_02 teszteset a PDF-fájlok webszerverre való helyezésével, megfelelő elnevezésével javítható.
